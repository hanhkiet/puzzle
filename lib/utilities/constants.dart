...
import 'package:puzzle/ui/app/svg_modify.dart';
      ...
      Padding(
        ...
        child: getTextWidgetWithMaxLine(
            Theme.of(context).textTheme.titleMedium!.copyWith(
                fontWeight: FontWeight.w500, color: color?.withOpacity(0.9)),
            content,
            TextAlign.start,
...
Widget getCommonDetailWidget({
  ...
  double size = iconSize ?? getPercentSize(mainHeight, 6);
  double font = fontSize ?? getPercentSize(mainHeight, 5);
  return Row(
    mainAxisAlignment:
    ...
    children: [
      ...
      SizedBox(
        width: horizontalSpace ?? getWidthPercentSize(context, 1.5),
      ),
      getTextWidget(
